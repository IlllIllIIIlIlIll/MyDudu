...
async function runApiTest() {
    console.log('🧪 Starting Clinical API Integration Test (Manual)...');

    // 1. Setup Data: Ensure Active Tree Exists
    console.log('📝 Seeding Mock Tree...');
    ...
    console.log('✅ Mock Tree Created:', tree.id);
    ...
    console.log('\n🛡️ Testing SUBMIT ANSWER (Invalid Node)...');
    try {
        ...
        console.log('✅ Correctly rejected invalid node:', e.message);
    }
