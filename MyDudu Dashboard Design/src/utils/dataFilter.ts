...
export function filterChildrenByUserRole(children: Child[], user: User | null): Child[] {
  if (!user) return [];
...
export function filterDevicesByUserRole(devices: Device[], user: User | null): Device[] {
  if (!user) return [];
...
export function filterValidationsByUserRole(validations: Validation[], user: User | null): Validation[] {
  if (!user) return [];
...
export function canAccessPage(page: string, user: User | null): boolean {
